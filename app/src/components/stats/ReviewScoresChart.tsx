...
import { ReviewScoresData } from '../../types/stats';
import { defaultChartOptions, greenColors } from '../../utils/chartConfig';

interface ReviewScoresChartProps {
  data: ReviewScoresData | null;
  loading: boolean;
}

const ReviewScoresChart: React.FC<ReviewScoresChartProps> = ({ data, loading }) => {
  const chartData = {
    ...
    datasets: [
      {
        ...
        borderWidth: 1,
        borderRadius: 6,
        hoverBackgroundColor: greenColors.tertiary,
      },
    ],
  };
    ...
    >
      <Card.Body style={{ padding: '24px' }}>
        <div style={{ marginBottom: '20px' }}>
          ...
          >
            {data?.avgRating
              ? `Promedio: ${data.avgRating.toFixed(1)} / 100`
...
export default ReviewScoresChart;
